<template>
  <div>
    <blockquote class="b-thick primary">
      <p>
        <strong>DOM 이벤트 특성 중 버블링과 캡처링에 대하여 정리</strong><br />
        <a href="https://ko.javascript.info/bubbling-and-capturing" target="_blank">참조: https://ko.javascript.info/bubbling-and-capturing</a>
      </p>
    </blockquote>
    <div class="row">
      <div class="col-md-12">
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title"><strong>이벤트 버블링</strong></h2>
            <p class="panel-subtitle">어떤 html 요소에 이벤트가 발생하면 <code>현재 요소에 먼저</code> 이벤트가 발생하고 <code>점차 상위로</code> 차근 차근 이벤트를 찾아가며 발생 하는 것.</p>
          </header>
          <div class="panel-body">
            <ul>
              <li>
                <h4>
                  <strong>버블링 이해</strong>
                </h4>
                <ol>
                  <li>
...
@Component({
  name: 'BubblingCapturing',
})
export default class BubblingCapturing extends Vue {
  private mounted() {
    window.prettyPrint();
    // 캡처링 이벤트 설정

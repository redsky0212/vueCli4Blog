<template>
  <div>
    <blockquote class="b-thick primary">
      <p><strong>v-bind를 이용하여 class 와 style에 여러가지 형태의 값을 바인딩 할 수 있다.</strong></p>
    </blockquote>
    <div class="row">
      <div class="col-md-12">
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title">
              <strong>class</strong>에 여러가지 값 셋팅 방법
              <!-- span class="text-danger">(사라질 예정)</span -->
            </h2>
            <p class="panel-subtitle">다양한 방법의 class값을 넣을 수 있다.</p>
          </header>
